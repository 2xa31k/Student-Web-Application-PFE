...
$query = "SELECT * FROM questions Where groupID='$ido' ORDER BY Time DESC LIMIT $page_first_result,$results_per_page";
              $result = $mysqli->query($query);
              ...
              <div class="media-body" style="background-color:#E9FFFF;">
                 ...
                 <?php echo'
                   ...
                   else echo "<em>Question Deleted...</em>";echo '</p>';
                ...
                if(mysqli_num_rows($resultsuser) == 1) {
                  ...
                  <?php if (!empty($profileimage1)) : ?>
                    ...
                    <?php echo '
                      ...
                      <div class="media-body rounded" style="background-color:#E9FFFF;">
                 ...
                 <?php endif ?>
                          ...
                          else echo '<em>response Deleted...</em>';echo '</p>
                       </div>
               </div> '
                  ;}
...
<div class="modal fade" id="Question">
    <div class="modal-dialog modal-lg">
      ...
      <?php include('question.php');?>
        ...
        <form action="allquestions?idg=<?php echo $ido;?>&p=<?php echo $p;?>" method="post">
        <!-- question -->
  ...
  <textarea class="form-control" rows="5" name="question" id="question"></textarea>
            ...
            <button type="submit" name="quest" class="btn btn-primary">Ajouter</button>
  </form>
        </div>
